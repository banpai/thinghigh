...
class Conf{
	...
	/**数据库名~*/
	public static $db_dbname = "thinghigh";
	/**数据库用户名~*/
	...
	/**数据库日志~是否需要记录操作数据库的SQL日志默认:false,日志地址:/log/db*/
	...
	/**系统日志级别~0：不输出日志，1：错误信息输出，2：警告和错误信息输出，3：提示、警告和错误信息输出4：提示、警告、错误和调试信息输出，日志地址:log*/
	...
	/**Jquery Url~Jquery的加载地址,默认为空。不设置则从框架加载*/
	...
	/**静态引用Url~为了提高访问速度(CDN等)网站静态文件(js/css/gif/jpg...)的Url路径。不存在静态文档服务器请设为空。*/
	...
	public static $session_prefix = "wyf";
}
?>
